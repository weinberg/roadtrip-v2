...
type Car struct {
	...
	Mph      int32     `protobuf:"varint,3,opt,name=mph,proto3" json:"mph,omitempty"`
}
...
type Location struct {
	...
	Miles   int32  `protobuf:"varint,3,opt,name=miles,proto3" json:"miles,omitempty"`
}
...
func (x *Location) GetMiles() int32 {
	if x != nil {
		return x.Miles
	}
	return 0
...
var file_internal_gameServer_grpc_game_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x05, 0x52, 0x03, 0x6d, 0x70, 0x68, 0x22, 0x51, 0x0a, 0x08, 0x4c, 0x6f, 0x63, 0x61,
	...
	0x20, 0x01, 0x28, 0x05, 0x52, 0x05, 0x6d, 0x69, 0x6c, 0x65, 0x73, 0x22, 0x07, 0x0a, 0x05, 0x45,
